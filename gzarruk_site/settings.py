"""
Django settings for gzarruk site project.
...
SECRET_KEY = env("SECRET_KEY", default="django-insecure-F7Tu8EGZi06AxlRAZOCs1Q9UweBtL97EIXJJTG8c")
...
ROOT_URLCONF = "gzarruk_site.urls"
...
WSGI_APPLICATION = "gzarruk_site.wsgi.application"
...
if "DATABASE_URL" in env:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env("DJANGO_DATABASE_NAME", default="gzarruk_site"),
...
LANGUAGE_CODE = "en-us"
LANGUAGE_COOKIE_NAME = "gzarruk_site_language"
...
if USE_S3_MEDIA:
    ...
    AWS_STORAGE_BUCKET_NAME = env("AWS_STORAGE_BUCKET_NAME", default="gzarruk_site-media")
...
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", default="gzarruk@gmail.com")
...
EMAIL_SUBJECT_PREFIX = "[gzarruk site] "
...
SPECTACULAR_SETTINGS = {
    "TITLE": "gzarruk site",
    "DESCRIPTION": "Convirtiendo datos y algoritmos en soluciones e innovación.",  # noqa: E501
    "VERSION": "0.1.0",
...
WAGTAIL_SITE_NAME = "gzarruk site Content"
...
PROJECT_METADATA = {
    "NAME": gettext_lazy("gzarruk site"),
    "URL": "http://localhost:8000",
    "DESCRIPTION": gettext_lazy("Convirtiendo datos y algoritmos en soluciones e innovación."),  # noqa: E501
    "IMAGE": "https://upload.wikimedia.org/wikipedia/commons/2/20/PEO-pegasus_black.svg",
    "KEYWORDS": "SaaS, django",
    "CONTACT_EMAIL": "gzarruk@gmail.com",
}

# set this to True in production to have URLs generated with https instead of http
USE_HTTPS_IN_ABSOLUTE_URLS = env.bool("USE_HTTPS_IN_ABSOLUTE_URLS", default=False)

ADMINS = [("Gustavo", "gzarruk@gmail.com")]
...
LOGGING = {
    ...
    "loggers": {
        ...
        "gzarruk_site": {
            "handlers": ["console"],
            "level": env("GZARRUK_SITE_LOG_LEVEL", default="INFO"),
        },
        "pegasus": {
            "handlers": ["console"],
